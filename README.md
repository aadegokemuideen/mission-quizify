### About Me:
Hello! My name is Muideen Adegoke. I am an AI researcher with a degree in Electrical Engineering. My expertise lies in learning algorithms and neural network models under imperfect implementations. In my career, including my PhD days, I developed several innovative algorithms and implemented them using Python and MATLAB. My work extensively involved statistical techniques, linear algebra, NLP/GenAI, large language model optimisation/finetuning, and optimization methods.
